...
<template>
    <div class="flex flex-row bg-background px-3 box-border justify-center w-full min-w-full max-w-full aspect-[7/1]">
        <button @click="go_home" class="aspect-square h-full min-h-full max-h-full bg-background flex flex-row justify-center items-center hover:bg-red-600">
            <ion-img class="aspec-square w-[50%]" src="icons/home.svg" alt="home"></ion-img>
        </button>
        <button @click="go_to_cart" class="aspect-square h-full min-h-full max-h-full bg-background flex flex-row justify-center items-center hover:bg-red-600 relative">
        ...
        <button @click="go_to_orders" class="aspect-square h-full min-h-full max-h-full bg-background flex flex-row justify-center items-center hover:bg-red-600">
            <ion-img class="aspec-square w-[50%]" src="icons/orders.svg" alt="orders"></ion-img>    
        </button>
        <button @click="go_to_tickets" class="aspect-square h-full min-h-full max-h-full bg-background flex flex-row justify-center items-center hover:bg-red-600">
            <ion-img class="aspec-square w-[50%]" src="icons/tickets.svg" alt="tickets"></ion-img>    
        </button>
        <button @click="try_logout" class="aspect-square h-full min-h-full max-h-full bg-background flex flex-row justify-center items-center hover:bg-red-600">
